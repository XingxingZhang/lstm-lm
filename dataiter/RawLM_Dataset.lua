...
function LM_Dataset.createVocab(inputFile, freqCut, ignoreCase, keepFreq, defaultUNK)
  ...
  --]]
  local UNK_STR = 'UNK'
  if defaultUNK == nil or defaultUNK == '' then
    word2idx = {UNK = wid}
    wid = wid + 1
  else
    UNK_STR = defaultUNK
  ...
  local vocab = {word2idx = word2idx, idx2word = idx2word, 
    ...
    keepFreq = keepFreq, UNK = word2idx[UNK_STR], UNK_STR = UNK_STR,
    EOS = word2idx['###eos###']}
  if keepFreq then
    vocab['freqs'] = freqs
